...
function loadNextFile() {
    ...
    STL.downloadSTL(next, function (mesh) {
...
function renderDiagnosticImages(camera, triMesh, size) {
    var cameraScale = Geometry.calculateCameraToPixel(camera, Geometry.getMeshBounds(triMesh), size, 0.05);
    var cameraAndScale = { camera: camera, scale: cameraScale };
...
function renderMeshView(triMesh) {
    ...
    var cameraSet = { front: Cameras.Front, top: Cameras.Top, right: Cameras.Right };
...
(function (CanvasUtilities) {
    function renderToNewCanvas(size, render) {
    ...
    CanvasUtilities.renderToNewCanvas = renderToNewCanvas;

    function renderImageDataToCanvas(canvas, imageData) {
    ...
    CanvasUtilities.renderImageDataToCanvas = renderImageDataToCanvas;
    ...
    CanvasUtilities.createCanvas = createCanvas;
})(CanvasUtilities || (CanvasUtilities = {}));
//# sourceMappingURL=renderTests.js.map
